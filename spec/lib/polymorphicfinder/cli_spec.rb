...
RSpec.describe Polymorphicfinder::CLI do
  let(:options) { [] }
  ...
  shared_examples_for "a version command" do
    it "prints version" do
      result = -> { cli }
      pattern = /#{Regexp.escape Polymorphicfinder::Identity.version_label}\n/
  ...
  shared_examples_for "a help command" do
    it "prints usage" do
      result = -> { cli }
      pattern = /#{Regexp.escape Polymorphicfinder::Identity.version_label}\scommands:\n/
